...
public:
     ...
     Animal(){
        this->weight = 0;//initialization of value inside constructor 
        this->age = 0;   //initialization of value inside constructor
        this->type = ""; //initialization of value inside constructor
